...
Новые бизнес-правила **не вводятся**; scope требований и модели BPMN **не расширяются и не противоречатся**.
...
| ERD / физическая модель БД | Отдельный раздел (`03-diagrams/erd/`) |
