...
**Связь с BPMN:** [BPMN-03](../bpmn/to-be-admin-configure.md)
...
Зафиксированы изоляция **route snapshot** уже отправленных заявок (BR-09) и валидация маршрута при активации (BR-18). Admin **не** создаёт заявки от имени сотрудника (BR-27).
