...
| **Message Flow** | Передача сообщения между участниками (in-app create — **Target**; email/push / mark-as-read — **Future / backlog**) |
...
| FR | FR-NOTIF-01 (**Target**), FR-AUDIT-02; FR-NOTIF-03 — **Future / backlog** | BPMN-01, BPMN-02 |
| FR | FR-ADMIN-01…05 (FR-ADMIN-06 кратко) — **Future / backlog** | BPMN-03 |
| BR | BR-06, BR-07, BR-08, BR-18, BR-19, BR-20, BR-22, BR-24, BR-26; BR-11, BR-23, BR-29 — **Target** | BPMN-01 |
| BR | BR-02, BR-03, BR-04, BR-05, BR-14, BR-15, BR-17, BR-21, BR-25; BR-23, BR-29 — **Target** | BPMN-02 |
| BR | BR-02, BR-08, BR-09, BR-10, BR-12, BR-18, BR-26; BR-27 — **Future / backlog** | BPMN-03 |
| AC | AC-APP-01, AC-APP-02, AC-APP-02b, AC-APP-03, AC-APP-05, AC-APP-05b, AC-APP-08, AC-REQ-07, AC-DRAFT-01, AC-DRAFT-02; AC-NOTIF-01 — **Target** | BPMN-01 |
...
Следующие UC / FR / AC отражают вход, просмотр или доступ, а не отдельный процесс согласования. В BPMN они не выносятся в отдельные диаграммы (могут упоминаться аннотацией как контекст):
