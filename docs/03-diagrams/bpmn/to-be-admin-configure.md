...
Процесс не создаёт заявки от имени сотрудника (BR-27). Изменения конфигурации не меняют RouteInstance уже отправленных заявок (BR-09; [Snapshot Model](../erd/snapshot-model.md)).
