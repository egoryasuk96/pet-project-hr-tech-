...
**Связи:** FR-REQ-02, FR-REQ-03, FR-REQ-09, FR-ADMIN-02, FR-CAT-03, UC-04, UC-05, AC-DRAFT-01, AC-DRAFT-02
...
| BR-27 | Admin не создаёт заявки от имени сотрудника |
| BR-28 | Свободные комментарии инициатора в in_approval |
| BR-29 | Уведомление в одной транзакции с бизнес-событием |

---

## 8. Согласованность с Vision & Scope

Проверка BR и закрытых решений против Vision & Scope v1.0: **противоречий не выявлено**. Scope не расширялся.
...
| OQ-FR-03 | Уведомление в одной транзакции с событием | BR-29 |
| OQ-FR-04 | Валидация маршрута при активации и при submit | BR-18 |
| OQ-HOME-01 | После login — ЛК + навигация по union roles | BR-16 |
...
| Multi-instance | Вне MVP, без искусственных ограничений архитектуры | NFR-SCL-01 |
...
**Обязательных для проектирования (Этап 3) открытых вопросов нет.**

Необязательные/операционные уточнения могут появиться на Этапах 4–6 (конкретные path OpenAPI, имена колонок БД) — они не блокируют моделирование предметной области.
...
| BR-16 | FR-AUTH-01, FR-AUTH-03 | UC-01 | AC-AUTH-01 |
...
| BR-26 | FR-REQ-02, FR-REQ-03, FR-ADMIN-02 | UC-04, UC-05 | AC-DRAFT-01, AC-DRAFT-02 |
| BR-27 | FR-REQ-01 | UC-04, UC-15 | AC-ACC-04 |
| BR-28 | FR-REQ-06 | UC-06 | AC-REQ-06 |
| BR-29 | FR-NOTIF-01 | UC-13 | AC-NOTIF-01 |
