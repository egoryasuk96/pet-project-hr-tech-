...
And создаются задачи этапа 2 (не этапа 1) — до выбора OQ-A/OQ-B в Snapshot Model §6  
And в истории есть событие повторной отправки (предыдущие версии значений доступны, BR-24)
