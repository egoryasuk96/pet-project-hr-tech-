...
## 14. Актуальная схема draft и валидация маршрута при активации

### AC-DRAFT-01 — Draft использует актуальную схему
**Related:** FR-REQ-02, FR-REQ-03, FR-ADMIN-02, BR-26

Given существует draft заявки типа T с сохранёнными значениями полей  
...
| AC-REQ-07 | Отмена |
| AC-DRAFT-01 | Актуальная схема draft |
...
| OQ-FR-03 | Уведомление в одной транзакции с событием | Да |
| OQ-HOME-01 | Стартовый экран при нескольких ролях | ЛК + навигация |

Закрыты: OQ-AC-01 (404), OQ-AC-02 (комментарий reject/return) — см. BR-25, NFR-SEC-05.
